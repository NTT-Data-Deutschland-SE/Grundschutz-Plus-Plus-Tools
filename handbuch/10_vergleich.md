...
3. **Status des ITGS-Mappings.** Draft mit 824 abgedeckten Teilanforderungen; die Gesamtzählung liegt inzwischen vor (Stand 2026-08-29): Gemessen am offiziellen XML-Kompendium 2023 — 1.834 aktive Anforderungen in 111 Bausteinen, zuzüglich 290 entfallene — berührt das ITGS-Mapping 510 Anforderungen (27,8 %), 1.324 bleiben ohne GSMap-Zuordnung. Die Kreuzanalyse mit dem GS++→ED23-Mapping der Werkzeugsammlung (5.086 Zuordnungen: beidrichtige Union auf Basis des amtlichen XML-Wortlauts — GS++-seitiger Maker-Checker plus satzweise ED23-seitige Prüfung —, nach einer Qualitäts-Stichprobe über 943 Paare bereinigt und die Relationstypen je Maßnahme als Familie mit expliziter Subsumtionsregel re-klassifiziert, Stand 2026-08-30) und dem Prozessbaustein-Mapping ergibt 141 Anforderungen (7,7 %) ohne jede Zuordnung aus irgendeiner der drei Quellen, weiterhin konzentriert in produktspezifischen SYS-, APP-, INF- und NET-Bausteinen; die fünf Prozess-Schichten sind vollständig abgedeckt. Auf Teilanforderungsebene sind 3.573 der 6.611 normativen Sätze des amtlichen Wortlauts (54,0 %) durch mindestens eine GS++-Maßnahme abgedeckt, jeder Satz einzeln beurteilt; 276 Anforderungen bleiben ohne einen einzigen abgedeckten normativen Satz. Zahlen, Methode und vollständige ID-Listen: `hilfsdateien/ed23_gap_report.md`, deterministisch reproduzierbar via `Gpp-ai-tool/scripts/analyze_ed23_coverage.py`. Offen bleibt der Draft-Status der Sammlung selbst.
